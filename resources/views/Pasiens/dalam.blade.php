...
<div class="container">
	...
	<div class="col-md-12">
		...
		<h1 class="text-capitalize mb-5 text-lg">POLI PENYAKIT DALAM</h1>
		</div>
	</div>
	</div>
	<div class="row">
		<div class="col-12">
			<div class="pagination_link">
				...
				<span>/</span>
				<a href="{{ route('pasiens.dalam') }}" class="text-white-50">Penyakit dalam</a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img">
					<img src="images/service/bg-12.jpeg" alt="" class="img-fluid rounded">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					...
					<p>Poli Penyakit Dalam kami adalah tempat di mana Anda dapat mendapatkan diagnosis yang akurat dan perawatan yang efektif untuk penyakit-penyakit yang berhubungan dengan organ dalam tubuh. Tim dokter spesialis penyakit dalam kami memiliki pengetahuan mendalam dalam mengidentifikasi dan mengelola berbagai kondisi medis seperti penyakit kardiovaskular, penyakit pernapasan, diabetes, gangguan pencernaan, dan gangguan imunologi.</p>
					...
					<ul class="list-unstyled department-service">
						...
						<li><i class="icofont-check mr-2"></i>Penilaian kesehatan umum</li>
						<li><i class="icofont-check mr-2"></i>pemeriksaan darah</li>
						<li><i class="icofont-check mr-2"></i>Tes diagnostik</li>
