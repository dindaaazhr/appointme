...
<div class="container">
	...
	<div class="col-md-12">
		...
		<h1 class="text-capitalize mb-5 text-lg">POLI MATA</h1>
		</div>
	</div>
	</div>
	<div class="row">
		<div class="col-12">
			<div class="pagination_link">
				...
				<span>/</span>
				<a href="{{ route('pasiens.mata') }}" class="text-white-50">Mata</a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Selamat datang di Poli Mata Kami!</h3>
					<div class="divider my-4"></div>
					<p class="lead">Poli Mata adalah fasilitas medis yang spesialis dalam diagnosis, pengobatan, dan perawatan masalah kesehatan yang terkait dengan mata.</p>
					<p> Poli Mata menawarkan pemeriksaan menyeluruh untuk mengidentifikasi masalah mata dan kondisi yang mungkin Anda alami. Ini termasuk pemeriksaan penglihatan, pemeriksaan tekanan intraokular, dan pemeriksaan retina.</p>


					<h3 class="mt-5 mb-4">Layanan Poli</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>Pemeriksaan Mata</li>
						<li><i class="icofont-check mr-2"></i>Kacamata dan Lensa Kontak</li>
						<li><i class="icofont-check mr-2"></i>Pengobatan Penyakit Mata</li>
						<li><i class="icofont-check mr-2"></i>Bedah Mata</li>
						<li><i class="icofont-check mr-2"></i>Perawatan Khusus</li>
