...
<!DOCTYPE html>
				...
				<div class="col-lg-6 col-md-12 col-xl-7">
					<div class="block">
						...
						<div class="btn-container ">
							<a href="appoinment.html" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Buat Janji<i class="icofont-simple-right ml-2  "></i></a>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="features" id="beranda">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-10 ">
					<div class="appoinment-wrap mt-5 mt-lg-0">
						...
						<a class="btn btn-main btn-round-full" href="appoinment.html" >Buat Janji<i class="icofont-simple-right ml-2  "></i></a>
					</form>
				</div>
				</div>
			</div>
				...
				<div class="col-lg-4 mr-auto col-sm-6">
					<div class="widget mb-5 mb-lg-0">
						...
						<ul class="list-inline footer-socials mt-4">
							<li class="list-inline-item"><a href="https://www.facebook.com/mahadidev7"><i class="icofont-facebook"></i></a></li>
							<li class="list-inline-item"><a href="https://twitter.com/mahadidev7"><i class="icofont-twitter"></i></a></li>
							<li class="list-inline-item"><a href="https://www.pinterest.com/mahadidev7/"><i class="icofont-linkedin"></i></a></li>
						</ul>
					</div>
				</div>
