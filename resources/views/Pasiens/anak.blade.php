...
<div class="container">
	...
	<div class="col-md-12">
		...
		<h1 class="text-capitalize mb-5 text-lg">POLI ANAK</h1>
		</div>
	</div>
	</div>
	<div class="row">
		<div class="col-12">
			<div class="pagination_link">
				...
				<span>/</span>
				<a href="{{ route('pasiens.anak') }}" class="text-white-50">Anak</a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Selamat datang di Poli Penyakit Dalam Kami!</h3>
					<div class="divider my-4"></div>
					<p class="lead">Poliklinik ini menyediakan layanan medis yang dirancang khusus untuk memenuhi kebutuhan kesehatan anak. </p>
					<p>Poliklinik Anak menawarkan pemeriksaan rutin untuk memantau pertumbuhan dan perkembangan anak. Selain itu, poliklinik ini juga menyediakan jadwal imunisasi lengkap untuk melindungi anak dari penyakit menular yang serius. Poliklinik Anak membantu dalam pemantauan perkembangan fisik, sosial, dan emosional anak. Dokter anak dapat memberikan saran tentang nutrisi yang tepat, menjawab pertanyaan mengenai tidur dan pola makan, dan memberikan dukungan dalam mengatasi masalah perilaku seperti gangguan tidur atau masalah kecemasan.</p>


					<h3 class="mt-5 mb-4">Layanan Poli</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>Pemeriksaan rutin</li>
						<li><i class="icofont-check mr-2"></i>Imunisasi</li>
						<li><i class="icofont-check mr-2"></i>Pengembangan dan Perilaku Anak</li>
						<li><i class="icofont-check mr-2"></i>Konsultasi Tumbuh Kembang</li>
						<li><i class="icofont-check mr-2"></i>Konseling dan Edukasi Orang Tua</li>
					</ul>
