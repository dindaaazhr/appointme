...
<div class="container">
	...
	<div class="col-md-12">
		...
		<h1 class="text-capitalize mb-5 text-lg">POLI OBGYN</h1>
		</div>
	</div>
	</div>
	<div class="row">
		<div class="col-12">
			<div class="pagination_link">
				...
				<span>/</span>
				<a href="{{ route('pasiens.obgyn') }}" class="text-white-50">Obgyn</a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Selamat datang di Poli Obgyn Kami!</h3>
					<div class="divider my-4"></div>
					<p class="lead">Poli Penyakit Dalam adalah unit pelayanan medis yang khusus menangani diagnosis, pengobatan, dan manajemen berbagai penyakit internal pada sistem tubuh manusia.</p>
					<p>Poli Obgyn memberikan perawatan selama proses persalinan, termasuk pemantauan tanda-tanda vital, bantuan persalinan, dan manajemen komplikasi yang mungkin timbul. Setelah melahirkan, poliklinik OBGYN juga memberikan perawatan pasca melahirkan, seperti pemantauan pemulihan ibu dan perawatan bayi baru lahir.Pemeriksaan rutin dan pemeriksaan spesifik terkait organ reproduksi perempuan, seperti pap smear untuk deteksi dini kanker serviks, pemeriksaan payudara, pemeriksaan panggul, dan pemeriksaan kondisi ginekologi lainnya.</p>


					<h3 class="mt-5 mb-4">Layanan Poli</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>Pemeriksaan Kehamilan</li>
						<li><i class="icofont-check mr-2"></i>Persalinan dan Perawatan Pasca Melahirkan</li>
						<li><i class="icofont-check mr-2"></i>Pemeriksaan Ginekologi</li>
						<li><i class="icofont-check mr-2"></i>Konseling dan Edukasi</li>
					</ul>
