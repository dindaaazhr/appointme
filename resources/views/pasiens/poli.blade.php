        ...
        <nav class="navbar navbar-expand-lg navigation" id="navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarmain">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dokter<i class="icofont-thin-down"></i></a>
...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <h1 class="text-capitalize mb-5 text-lg">Poli Kami</h1>
    ...
    <div class="row">
        <div class="col-12">
            <div class="pagination_link">
                ...
                <span>/</span>
                <a href="{{ route('pasiens.poli') }}" class="text-white-50">Poli</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.anak') }}">
                            <h4 class="mt-4 mb-2 title-color">POLI ANAK DAN TUMBUH KEMBANG</h4>
                        </a>
                        <p class="mb-4">Kami menyediakan berbagai layanan kesehatan anak, termasuk pemeriksaan rutin, imunisasi, konsultasi perkembangan, perawatan penyakit umum...</p>
                        <a href="{{ route('pasiens.anak') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.mata') }}">
                            <h4 class="mt-4 mb-2  title-color">POLI MATA</h4>
                        </a>
                        
                        <p class="mb-4">Poliklinik Mata menawarkan pemeriksaan menyeluruh untuk mengidentifikasi masalah mata dan kondisi yang mungkin Anda alami. Ini termasuK..</p>
                        <a href="{{ route('pasiens.mata') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.dalam') }}">
                            <h4 class="mt-4 mb-2 title-color">POLI PENYAKIT DALAM (INTERNA)</h4>
                        </a>
                        
                        <p class="mb-4">Poliklinik Penyakit Dalam menyediakan pemeriksaan rutin untuk penilaian kesehatan umum, termasuk pemeriksaan fisik, pengukuran tekanan darah, pemeriksaan detak...</p>
                        <a href="{{ route('pasiens.dalam') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.obgyn') }}">
                            <h4 class="mt-4 mb-2 title-color">POLI OBGYN (OBSTETRI & GINEKOLOGI)</h4>
                        </a>
                        
                        <p class="mb-4">POLI OBGYN (Obstetri dan Ginekologi) adalah poliklinik khusus yang menangani masalah kesehatan perempuan terkait kehamilan...</p>
                        <a href="{{ route('pasiens.obgyn') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.bedah') }}">
                            <h4 class="mt-4 mb-2 title-color">POLI BEDAH UMUM</h4>
                        </a>
                        
                        <p class="mb-4">Poliklinik Bedah menyediakan persiapan pra-bedah, yang meliputi tes laboratorium, pemindaian medis (seperti MRI atau CT scan), dan evaluasi...</p>
                        <a href="{{ route('pasiens.bedah') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        <a href="{{ route('pasiens.saraf') }}">
                            <h4 class="mt-4 mb-2 title-color">POLI SARAF</h4>
                        </a>
                        
                        <p class="mb-4">Poliklinik Saraf menyediakan konsultasi dengan dokter spesialis neurologi untuk mengevaluasi gejala dan masalah kesehatan yang terkait dengan sistem..</p>
                        <a href="{{ route('pasiens.saraf') }}">Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="cta-content">
                    ...
                    <h2 class="mb-5 text-lg">Kesehatan anda adalah kepuasan bagi kami.</span></h2>
                    ...
                    <a href="{{ route('pasiens.janji') }}" class="btn btn-main-2 btn-round-full">Buat janji sekarang<i class="icofont-simple-right  ml-2"></i></a>
                </div>
            </div>
        </div>
    </div>
