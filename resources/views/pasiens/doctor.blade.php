        ...
        <section class="page-title bg-1">
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <span class="text-white">Daftar Dokter</span>
            ...
            <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <div class="section-title">
                            ...
                            <p>Kami menyediakan berbagai layanan kreatif yang luas dengan kualitas terbaik. Dengan pengalaman dan keahlian dalam industri ini, kami siap memberikan solusi yang tepat untuk memenuhi kebutuhan Anda. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="cta-content">
                            ...
                            <a href="{{ route('pasiens.janji') }}" class="btn btn-main-2 btn-round-full">Get appoinment<i class="icofont-simple-right  ml-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
